...
Bootstrap status:
  ...
  --bundle-create assembles a local airgap bundle and immediately runs airgap-bundle-check only; optional external-declared airgap evidence output is an unsigned focused envelope, not release readiness.

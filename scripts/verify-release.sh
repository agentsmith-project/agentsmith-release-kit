...
Usage:
  ...
  bash scripts/verify-release.sh --airgap-consume-rehearsal --bundle-root <dir> [--bundle-manifest <bundle-local-json>] --render-values <bundle-local-json> --substrate-truth <bundle-local-json> --target-prerequisites <json> --namespace <name> --output-dir <dir> [--rehearsal-target existing_kubernetes|kind_rehearsal] [--mode server-dry-run|apply] [--kubeconfig <path>] [--context <name>] [--kubectl <path>] [--archive-probe <executable>] [--image-loader <executable>] [--confirm-apply existing_kubernetes/external_declared/airgap] [--operator-run-id <id>] [--timeout <duration>] [--smoke-url <https-url>] [--expected-status <code>] [--timeout-ms <ms>] [--allow-http] [--allow-localhost] [--forbidden-source-root <dir>]
  ...
  bash scripts/verify-release.sh --apply --release-contract <json> --rendered-manifests <dir> --target-profile existing_kubernetes/external_declared/<online|airgap>|existing_kubernetes/kit_installed/online --namespace <name> --output-dir <dir> [--mode server-dry-run|apply] [--kubeconfig <path>] [--context <name>] [--kubectl <path>] [--forbidden-source-root <dir>]
  bash scripts/verify-release.sh --apply --release-contract <json> --rendered-manifests <dir> --target-profile existing_kubernetes/external_declared/<online|airgap>|existing_kubernetes/kit_installed/online --namespace <name> --output-dir <dir> --mode apply --confirm-apply <matching-target-profile> --operator-run-id <id> [--kubeconfig <path>] [--context <name>] [--kubectl <path>] [--forbidden-source-root <dir>]
  bash scripts/verify-release.sh --rollout --release-contract <json> --rendered-manifests <dir> --target-profile existing_kubernetes/external_declared/<online|airgap>|existing_kubernetes/kit_installed/online --namespace <name> --output-dir <dir> [--timeout <duration>] [--kubeconfig <path>] [--context <name>] [--kubectl <path>] [--forbidden-source-root <dir>]
  ...
  bash scripts/verify-release.sh --online-deployment-gate --release-contract <json> --deploy-template-package <json> --archive <tgz> --target-profile existing_kubernetes/kit_installed/online --render-values <json> --substrate-truth <json> --target-prerequisites <json> --substrate-pack-manifest <json> --routability-probe <executable> --namespace <name> --output-dir <dir> [--mode server-dry-run|apply] [--kubeconfig <path>] [--context <name>] [--kubectl <path>] [--confirm-apply existing_kubernetes/kit_installed/online] [--operator-run-id <id>] [--timeout <duration>] [--smoke-url <https-url>] [--expected-status <code>] [--timeout-ms <ms>] [--allow-http] [--allow-localhost] [--forbidden-source-root <dir>]
...
Bootstrap status:
  ...
  --airgap-consume-rehearsal discovers bundle components from an already assembled bundle, then runs bundle-check plus the airgap focused chain for an existing Kubernetes or kind rehearsal target only; it is not package, offline install, registry mirror, operator signoff, deploy, or release readiness.
